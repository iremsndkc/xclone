...
const Nav = ({user}) => {
  return (
    <nav className='flex flex-col justify-between items-end px-2 py-4'>
      <div>
        <img src="xlogo.png" className="w-14 mb-4" />
        {navSections.map((i,key) => (
        <div 
        key={key}
        className='flex items-center gap-3 text-xl p-3 cursor-pointer 
      ...
      <div>
        ...
        <div className='flex flex-col gap-5'>
          ...
          className='flex justify-center items-center gap-2 md:text-[15px] p-1 bg-zinc-700
          text-xl rounded transition hover:bg-zinc-900'>
            <BiSolidDoorOpen/>
